...
export const fetchFundings = createAsyncThunk(
  "funding/fetchFundings",
  async () => {
    const response = await axiosAccessInstance.get("/funding");
...
export const fetchSinglefunding = createAsyncThunk(
  ...
  async (fundingId: any) => {
    const response = await axiosAccessInstance.get(`/funding/${fundingId}`);
...
export const fetchMyFunding = createAsyncThunk(
  ...
  async () => {
    const response = await axiosAccessInstance.get("/enrol-funding/user-enrol");
...
export const fetchFundingWithStatus = createAsyncThunk(
  ...
  async (status: any) => {
    const response = await axiosAccessInstance.get(
...
export const fetchSavedFundings = createAsyncThunk(
  ...
  async () => {
    const response = await axiosAccessInstance.get("/funding-wish/user");
    return response.data.data;
  }
);
...
export const deleteMyFunding = createAsyncThunk(
  ...
  async (enrolId: any) => {
    await axiosAccessInstance.delete(`/enrol-funding/${enrolId}`);
...
export const deleteFunding = createAsyncThunk(
  ...
  async (fundingId) => {
    await axiosAccessInstance.delete(`/funding/${fundingId}`);
