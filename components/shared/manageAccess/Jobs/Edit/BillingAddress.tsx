      ...
      <div className="px-6">
        ...
        <div>
          ...
          <Form layout="vertical" form={form} size="large">
            ...
            >
              <Input placeholder="Full Name(First and Last Name)" className="p-4" />
            </Form.Item>
            <Form.Item
              name="phoneNumber"
              label="Phone Number"
            ...
            >
              <Input type="number" placeholder="Phone Number" className="p-4" />
            </Form.Item>
            <Form.Item
              name="address"
              label="Address"
            ...
            >
              <Input placeholder="Address" className="p-4" />
            </Form.Item>
            <Row gutter={[16, 16]}>
              <Col lg={8}>
                <Form.Item
