...
const CourseLandingPage = () => {
  ...
  const [showScholarshipOptions, setShowScholarshipOptions] = useState(true);
  ...
  useEffect(() => {
    if (courseData?.data) {
      ...
      setImageUrl(image);
      setVideoUrl(video);
      setIsExternal(formData.isExternal);
  ...
  const handleFinish = async () => {
    ...
    try {
      const res = await axiosAccessInstance.put(
        `/manage-course/${courseData?.data?.id}`,
        {
          ...requestBody,
        }
      );
      ...
      // message.error("Unable to Save Job. Try Again");
    }
  ...
  const handleScholarship = (e: RadioChangeEvent) => {
    ...
    setShowScholarshipOptions(e.target.value);
  };
    ...
    <>
      ...
      <div className="ml-2 mb-4">
        <Typography.Paragraph className="font-semibold italic">
          Are you uploading the course content on Unifaires?
        </Typography.Paragraph>
      ...
      <div className="ml-2 mb-4">
        ...
        <div>
          <Radio.Group onChange={handleScholarship}>
            <Space direction="horizontal">
              <Radio value={true}>Yes</Radio>
              <Radio value={false}>No</Radio>
            </Space>
            ...
            <Col lg={12}>
              ...
              >
                <Select
                  ...
                  options={programStartDateOption}
                />
              </Form.Item>
            </Col>
            <Col lg={12}>
