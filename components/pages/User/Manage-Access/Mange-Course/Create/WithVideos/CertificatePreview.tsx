              ...
              <div className="flex flex-col justify-center items-center p-8">
                ...
                <div>
                  ...
                  <Typography.Paragraph className="uppercase text-center text-xs w-[350px]">
                    ...
                    recognized as a Unifares Certified Azuri AI Fundamentals
                  </Typography.Paragraph>
                </div>
                <div className="mt-4">
                ...
                <div className="flex flex-row gap-4 justify-between w-full mt-8">
                  ...
                  <div className="w-1/3">
                    ...
                    <Typography.Paragraph className="capitalize text-center">
                      Unifaires Chief Executive Officer
                    </Typography.Paragraph>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 pt-0">
                ...
                <div className="flex flex-row gap-2">
                  ...
                  <div>
                    ...
                    <Typography.Paragraph className="m-2">
                      View: https://verify.unifares.com
                    </Typography.Paragraph>
                  </div>
                </div>
              </div>
            ...
            <div className="p-12">
              ...
              <div>
                <Typography.Paragraph>
                  ...
                  <span className="font-bold">Mr. Mirza Maaz Ali Baig</span>{" "}
                  from
                  <span className="font-bold">
                    {" "}
                    Ajman University of Science and Technolgy Ajman,
                  </span>{" "}
                  has successfully completed his internship at{" "}
                  <span className="font-bold">Scientechin</span> form{" "}
                  <span className="font-bold">
                ...
                <Typography.Paragraph>
                  ...
                  activities in
                  <span className="font-bold">
                    Automation Products and Services Division.
                  </span>
                </Typography.Paragraph>
                <Typography.Paragraph>
