...
const CourseContent = () => {
  ...
  const handleSaveSection = async () => {
    if (status === "authenticated" && session?.user?.token) {
      ...
      setLoading(true);
      try {
        const response = await fetch(`${config.API.API_URL}/section`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            "x-token": session?.user?.token,
          },
          body: JSON.stringify({ ...formData, courseId: courseData?.data?.id }),
        });
        if (response.ok) {
  ...
  const handleDeleteSection = async (id: number) => {
    if (status === "authenticated" && session?.user?.token) {
      try {
        const response = await fetch(`${config.API.API_URL}/section/${id}`, {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
            "x-token": session?.user?.token,
        ...
        if (response.ok) {
          ...
          message.error("Unable to Delete Section. Try again");
        }
      } catch (error) {
        message.error("Unable to Delete Section. Try again");
      }
  ...
  const handleSaveSectionTitle = async (id: number) => {
    setLoading(true);
    if (status === "authenticated" && session?.user?.token) {
      try {
        const response = await fetch(`${config.API.API_URL}/section/${id}`, {
        ...
        if (response.ok) {
          ...
          message.error("Section Updated Failed");
        }
      } catch (error) {
        message.error("Section Updated Failed");
      }
  ...
  const handleSaveLectureTitle = async (id: number) => {
    setLoading(true);
    if (status === "authenticated" && session?.user?.token) {
      try {
        const response = await fetch(`${config.API.API_URL}/lecture/${id}`, {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
            "x-token": session?.user?.token,
        ...
        if (response.ok) {
          ...
          message.error("Lecture Updated Failed");
        }
      } catch (error) {
        message.error("Lecture Updated Failed");
      }
    ...
    if (status === "authenticated" && session?.user?.token) {
      try {
        ...
        if (response.ok) {
          ...
          message.error("Unable to Delete Lecture. Try again");
        }
      } catch (error) {
        message.error("Unable to Delete Lecture. Try again");
      }
  ...
  const handleSaveLecture = async (section: { id: number }) => {
    if (status === "authenticated" && session?.user?.token) {
      setLoading(true);
      try {
        const response = await fetch(`${config.API.API_URL}/lecture`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            "x-token": session?.user?.token,
        ...
        if (response.ok) {
          ...
          message.error("Lecture Created Failed");
        }
      } catch (error) {
        message.error("Lecture Created Failed");
      }
