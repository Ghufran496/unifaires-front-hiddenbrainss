...
const HomeFundingsCard = (props: any) => {
  return (
    <Fragment>
      <Link href={`/funding/${props.slug}`} passHref rel="noopener noreferrer">
        ...
        >
          <div className="flex lg:flex-col md:flex-col flex-row">
            <div className="flex lg:justify-center md:justify-center justify-start lg:items-center md:items-center items-start p-2 rounded-t-xl aspect-[4/3] relative lg:bg-grey-200 md:bg-gray-200 bg-none lg:h-[200px] md:h-[200px]">
              <ImageComponent
                width={100}
                height={100}
...
export default HomeFundingsCard;
