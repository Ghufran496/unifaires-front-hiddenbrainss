...
const [isMediaUrlUploadedEmpty, setIsMediaUrlUploadedEmpty] = useState<boolean>(true)
  ...
  const nextStep = async () => {
    if(imageUrl === null) {
      setIsMediaUrlUploadedEmpty(false)
  ...
  const onImageRemove = () => {
    setImageUrl(null)
    setIsMediaUrlUploadedEmpty(true)
  }
    ...
    <Fragment>
      ...
      >
        ...
        >
            ...
            >
              <div className="flex justify-center items-center">
                {imageUrl ? (
                  ...
                  <Typography.Title level={1} className="mb-0 text-purple-500" onClick={()=> setImageUrl(null)}>
          ...
          <p className="text-red-500 font-sm">{(!isMediaUrlUploadedEmpty && imageUrl === null) && "Course Cover Image is required *"}</p> 
        </Form.Item>
        <Form.Item
          required
        ...
        >
          ...
          <p className="text-red-500 font-sm">{(!isMediaUrlUploadedEmpty && videoUrl === null) && "Promotional Video is required *"}</p> 
        </Form.Item>
